...
def timeseries(vars, pn, bts, bte,  lwp_time, pwv_time, aeri, time, id, st):
    ...
    if ps[0] >= 0:
        ...
        ax[ps[0]].set_title(lab[ps[0]],loc='left',fontsize=8,pad=3.0, fontweight='bold')
      
    
        
        #cbar_ax = fig.add_axes([1.1, 0.11, 0.027, 0.76]) #lbwh #new
        cbar_ax = fig.add_axes([1.05, 0.65, 0.027, 0.23]) #lbwh #new
    ...
    if ps[1] >=0:
        ...
        ax[ps[1]].set_ylabel("MSL [km]", fontsize=7.2) #new
        ax[ps[1]].set_yticks(yticks)
        #ax[ps[1]].set_yticklabels(yticklabels, fontsize=13)
        ax[ps[1]].set_yticklabels(yticklabels, fontsize=5) #new
        ax[ps[1]].set_xticks(ticks)
        if ps[1] == max(ps):
            #ax[ps[1]].set_xticklabels(labels, fontsize=10.1)
            ax[ps[1]].set_xticklabels(labels, fontsize=2.3, fontweight='bold') #new
        ...
        ax[ps[1]].set_title(lab[ps[1]],loc='left',fontsize=8,pad=3.0, fontweight='bold')
        #cbar_ax1 = fig.add_axes([1.1, 0.11, 0.027, 0.76]) #lbwh #new
        cbar_ax = fig.add_axes([1.05, 0.37, 0.027, 0.24]) #lbwh #new
        
        cbar = fig.colorbar(circle, norm=norm, cax=cbar_ax, ax=ax[ps[1]],extend= "both") #new
    ...
    if ps[2] >= 0:
        ...
        ax[ps[2]].set_ylabel("MSL [km]", fontsize=7.2) #new
        ax[ps[2]].set_yticks(yticks)
        #ax[ps[2]].set_yticklabels(yticklabels, fontsize=13)
        ax[ps[2]].set_yticklabels(yticklabels, fontsize=5) #new
        ax[ps[2]].set_xticks(ticks)
        if ps[2] == max(ps):
            #ax[ps[2]].set_xticklabels(labels, fontsize=10.1)
            ax[ps[2]].set_xticklabels(labels, fontsize=2.3, fontweight='bold') #new
        ...
        ax[ps[2]].set_title(lab[ps[2]], loc='left',fontsize=8, pad=3.0, fontweight='bold')
        
        cbar_ax = fig.add_axes([1.05, 0.11, 0.027, 0.23]) #lbwh #new
        
        cbar = fig.colorbar(circle, norm=norm, cax=cbar_ax, ax=ax[ps[2]],extend= "max") #new
